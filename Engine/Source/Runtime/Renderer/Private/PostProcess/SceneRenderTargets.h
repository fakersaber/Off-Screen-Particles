...
public:
	...
	/** Begin rendering mobile translucency in a separate (offscreen) buffer. This can be any translucency pass. */
	void BeginRenderingMobileSeparateTranslucency(FRHICommandList& RHICmdList, const FViewInfo& View, FIntPoint MobileSeparateTranslucencyBufferSize, float DownsamplingScale);
