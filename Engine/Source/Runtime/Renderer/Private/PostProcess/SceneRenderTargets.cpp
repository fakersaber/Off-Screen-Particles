...
//YJH Created
void FSceneRenderTargets::BeginRenderingMobileSeparateTranslucency(FRHICommandList& RHICmdList, const FViewInfo& View, FIntPoint MobileSeparateTranslucencyBufferSize, float DownsamplingScale) {

	check(RHICmdList.IsOutsideRenderPass());

	TRefCountPtr<IPooledRenderTarget>* SeparateTranslucency;
	SeparateTranslucency = &GetSeparateTranslucency(RHICmdList, MobileSeparateTranslucencyBufferSize);
	...
	RHICmdList.SetViewport(0, 0, 0.0f, FMath::TruncToInt(View.ViewRect.Width() * DownsamplingScale), FMath::TruncToInt(View.ViewRect.Height() * DownsamplingScale), 1.0f);
