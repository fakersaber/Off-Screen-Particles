...
public:
	...
	static void ModifyCompilationEnvironment(const FMaterialShaderPermutationParameters& Parameters, FShaderCompilerEnvironment& OutEnvironment)
	{
		...
		ModifyComplilationEnviromentForDownSampleTranslucency(Parameters.MaterialParameters, OutEnvironment);
	}
...
private:
	...
	//YJH Created By 
	static bool ModifyComplilationEnviromentForDownSampleTranslucency(const FMaterialShaderParameters& MaterialParameters, FShaderCompilerEnvironment& OutEnvironment);
};
